                            ...
                            <div class="country">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <xsl:value-of select="society/language/official/name"/>
                                        (official)<xsl:if test="string(society/language/official/percentage)">&#160;<xsl:value-of select="society/language/official/percentage"/>%</xsl:if><xsl:for-each select="society/language/unofficial">,
                                        <xsl:value-of
